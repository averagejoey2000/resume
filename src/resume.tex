...
\simpleheader{headercolour}{Joey}{Simone}{Third Officer}{white}
...
{\footnotesize
I am a Third Officer for vessels of Unlimited Tonnage.}
\bigskip
...
Celestial Navigation ~•~ Training ~•~ Enabling Others ~•~ Independent Function
...
My creative pursuits include singing, cooking, creative and instructional writing, drag, and most recently \LaTeX.
\bigskip

\bg{cvgreen}{white}{Interests}\\[0.5em]

\LaTeX{} ~/~ \texttt{Android} ~/~ \texttt{Linux}
\vspace{4em}

\infobubble{\faAt}{cvgreen}{white}{averagejoey2000@gmail.com}
\infobubble{\faTwitter}{cvgreen}{white}{@averagejoey2000}
\infobubble{\faFacebook}{cvgreen}{white}{Joey Simone}
\infobubble{\faGithub}{cvgreen}{white}{averagejoey2000}
...
{\small Joey Simone \icon{\faEnvelopeO}{cvgreen}{} The Black Pearl \icon{\faMapMarker}{cvgreen}{} Tortuga \icon{\faPhone}{cvgreen}{} 0099/333 5647380 \newline\icon{\faAt}{cvgreen}{} \protect\url{jack@sparrow.com}
}
\end{center}
\end{minipage}
